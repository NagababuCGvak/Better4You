...
namespace Better4You.UI.Mvc.Controllers
{
    public class MealController : ControllerBase
    {
        ...
        public ActionResult Monthly()
        {
            ...
            ViewBag.menu = menu.Select(d => new SelectListItem { Text = d.Text, Value = d.Id.ToString(), Selected = (d.Id == schoolMenu) }).ToList();
        ...
        public JsonResult MealMenusByType(MealMenuGetAllRequest request)
        {
            ...
            var response = MealMenuService.GetAllByFilter1(request);
