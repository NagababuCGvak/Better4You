using Better4You.UserManagement.Config;
using System;
...
namespace Better4You.Meal.Config
{
    public static class Lookups
    {
        ...
        public static List<GeneralItemView> MenusNameList
        {
            get
            {
                return new List<GeneralItemView>
                       {
                           new GeneralItemView((int)Menus.None,Menus.None.ToString("G"),"None"),
                           new GeneralItemView((int)Menus.Menu1,Menus.Menu1.ToString("G"),"Menu #1"),
                           new GeneralItemView((int)Menus.Menu2,Menus.Menu1.ToString("G"),"Menu #2"),
                           new GeneralItemView((int)Menus.Menu3,Menus.Menu1.ToString("G"),"Menu #3"),
                       };
            }
        }
